========================================================================
    APLICACIÓN DE CONSOLA: Practica8LibreriaCliente Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Practica8LibreriaCliente.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación Practica8LibreriaCliente.


Practica8LibreriaCliente.vcxproj
...
Practica8LibreriaCliente.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado Practica8LibreriaCliente.pch y un archivo de tipos precompilados llamado StdAfx.obj.
